  ...
  return (
    <div className="relative w-full h-full flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 w-full flex flex-col justify-center px-10 md:px-14 lg:px-20 py-14 bg-panthera-black border-t md:border-t-0 md:border-l border-[rgba(245,245,245,0.06)]">
        <span
          className="font-serif text-[100px] md:text-[140px] text-[rgba(245,245,245,0.03)] leading-none select-none -ml-2 -mt-4 block"
          aria-hidden="true"
        >
          &#8220;
        </span>
        <p
          className="font-sans text-panthera-white/80 leading-relaxed mb-8 -mt-8"
  ...
  return (
    <section className="bg-panthera-black">
      ...
      <div className="container-panthera pt-28 md:pt-36 pb-20 md:pb-28">
        ...
        <h2
          className="font-serif text-panthera-white leading-tight mb-6 max-w-2xl"

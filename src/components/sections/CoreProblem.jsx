...
export default function CoreProblem() {
  ...
  return (
    <section className="relative bg-[#050505] py-16 md:py-32 lg:py-40 overflow-hidden">
      ...
      <div ref={containerRef} className="relative z-20 container-panthera">
        <div className="max-w-4xl">
          ...
          <h2
            ref={headlineRef}
            className="font-serif text-[2.05rem] md:text-5xl lg:text-6xl text-panthera-white leading-[1.04] md:leading-tight mb-7 md:mb-10"
          >
            {problem.headline}
          </h2>

          <div className="space-y-4 md:space-y-5 mb-8 md:mb-12 max-w-2xl">
          ...
          <p className="closing-text font-serif italic text-base md:text-2xl text-panthera-cream mb-8 md:mb-10 max-w-[340px] md:max-w-none leading-snug">
            {problem.closing}
          </p>

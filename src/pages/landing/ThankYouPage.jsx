...
function TestimonialCard({ c }) {
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-sm border border-[rgba(245,245,245,0.07)] bg-[#0c0c0b] text-center">
      {/* Cover / Video */}
      ...
      {/* Text */}
      <div className="flex flex-col items-center p-5 md:p-6 flex-1">
        <p className="font-sans text-[9px] uppercase tracking-[0.2em] text-panthera-green mb-1">
          Resultado
        </p>

        <p className="font-sans font-medium text-sm text-panthera-white mb-1">
          {c.name}
        </p>

        <p className="font-sans text-[11px] text-panthera-green/80 mb-3">
          {c.role}
        </p>

        <p className="font-sans text-xs text-panthera-white/65 leading-relaxed max-w-[92%] mx-auto">
          {c.description}
        </p>
      </div>
    </div>
...
function StepCard({ num, text }) {
  return (
    <div className="relative flex min-h-[180px] flex-col items-center justify-center gap-4 rounded-sm border border-[rgba(227,247,141,0.14)] bg-[#0a0a09] p-5 text-center md:p-6">
      <span
        className="font-sans text-3xl md:text-4xl font-bold text-panthera-green leading-none select-none"
        aria-hidden="true"
      >
        {num}
      </span>

      <p className="font-sans text-sm md:text-[15px] text-panthera-white/80 leading-relaxed max-w-[240px] mx-auto">
        {text}
      </p>
    </div>
  )
...
export default function ThankYouPage() {
  ...
  return (
    <div className="landing-root bg-panthera-black text-panthera-white min-h-screen selection:bg-panthera-green/30">
      {/* ── HERO / CONFIRMACIÓN ─────────────────────────────────────────── */}
      <section
      ...
      <section className="relative py-20 md:py-28 overflow-hidden text-center" aria-label="Paso 1 — Video">
        <div className="container-panthera">
          ...
          <div ref={step1Ref} className="mb-10 md:mb-14 text-center max-w-3xl mx-auto">
            <p className="font-sans text-[14px] md:text-[16px] uppercase tracking-[0.22em] text-panthera-green mb-4">
              Paso 1
            </p>
            ...
            <p className="font-sans text-base text-panthera-white/55 max-w-lg mx-auto">
              Te va a evitar perder tiempo en la llamada
              <br />
              y entender si esto aplica para vos.
            </p>
          </div>

          {/* Video embed */}
          <div ref={videoBoxRef} className="relative w-full max-w-3xl mx-auto mb-14 md:mb-20">
            <div
              className="relative w-full overflow-hidden rounded-sm border border-[rgba(245,245,245,0.08)] shadow-[0_0_60px_rgba(0,0,0,0.6)]"
      ...
      {/* ── PASO 2 / CALENDARIO ────────────────────────────────────────── */}
      <section className="relative py-20 md:py-28 border-t border-[rgba(245,245,245,0.05)] text-center" aria-label="Paso 2 — Aceptar invitación">
        <div className="container-panthera">
          <div ref={step2Ref} className="max-w-3xl mx-auto text-center">
            <p className="font-sans text-[14px] md:text-[16px] uppercase tracking-[0.22em] text-panthera-green mb-4">
              Paso 2
            </p>
            ...
            <p className="font-sans text-base text-panthera-white/55 leading-relaxed mb-10 md:mb-14 max-w-xl mx-auto">
            ...
            <div className="relative mx-auto w-full max-w-3xl overflow-hidden rounded-sm border border-[rgba(245,245,245,0.08)] shadow-[0_8px_60px_rgba(0,0,0,0.55)]">
              <img
      ...
      {/* ── PASO 3 / CASOS REALES ──────────────────────────────────────── */}
      <section className="relative py-20 md:py-28 border-t border-[rgba(245,245,245,0.05)] overflow-hidden text-center" aria-label="Paso 3 — Casos reales">
        ...
        <div className="container-panthera relative z-10">
          <div ref={step3Ref} className="mb-10 md:mb-14 text-center max-w-3xl mx-auto">
            <p className="font-sans text-[14px] md:text-[16px] uppercase tracking-[0.22em] text-panthera-green mb-4">
              Paso 3
            </p>
            ...
            <h2
              ...
              style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.6rem)' }}
            >
              <span className="block">Casos de personas</span>
              <span className="block">con las que trabajamos</span>
            </h2>

            <p className="font-sans text-base text-panthera-white/55 max-w-xl leading-relaxed mx-auto">

      ...
      <div ref={containerRef} className="relative z-10 container-panthera">
        ...
        <div className="max-w-4xl mb-12 md:mb-16">
          ...
          <h2 className="md:hidden font-serif text-panthera-white leading-tight mb-4" style={{ fontSize: 'clamp(1.8rem, 3.5vw, 3rem)' }}>
            {comparison.headline.replace(/\n/g, ' ')}
          </h2>

          <h2 className="hidden md:block font-serif text-panthera-white leading-tight mb-4 whitespace-pre-line" style={{ fontSize: 'clamp(1.8rem, 3.5vw, 3rem)' }}>
            {comparison.headline}
          </h2>

          <p className="md:hidden font-sans text-sm text-panthera-ash leading-relaxed">
            {comparison.subheadline.replace(/\n/g, ' ')}
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-4 mb-12 md:mb-16">
          {/* Traditional */}
        ...
        {/* Closing + CTA */}
        <div className="max-w-5xl mb-10 md:mb-10">
          <p className="md:hidden font-serif italic text-panthera-cream leading-snug max-w-5xl" style={{ fontSize: 'clamp(1.05rem, 2vw, 1.5rem)' }}>
            {comparison.closing.replace(/\n/g, ' ')}
          </p>
          <p className="hidden md:block font-serif italic text-panthera-cream leading-snug whitespace-pre-line max-w-5xl" style={{ fontSize: 'clamp(1.05rem, 2vw, 1.5rem)' }}>
            {comparison.closing}
          </p>
        </div>

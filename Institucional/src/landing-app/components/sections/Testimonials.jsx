  ...
  return (
    <div className="group relative flex flex-col h-[420px] md:h-[450px] bg-[#0c0c0b] border border-[rgba(245,245,245,0.07)] overflow-hidden">
      ...
      <div className="flex flex-col p-4 md:p-5 flex-1">
        ...
        <p
          className="font-sans text-xs text-panthera-white/65 leading-relaxed overflow-hidden"
          style={{
            display: '-webkit-box',
...
export default function Testimonials() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#0f100f]">
      ...
      <div className="relative z-10 container-panthera pt-24 md:pt-36 pb-6 md:pb-10">
        <p className="font-sans text-[10px] uppercase tracking-[0.2em] text-panthera-green mb-5">
          {testimonials.eyebrow}
        </p>

        <h2 className="md:hidden font-serif text-panthera-white leading-[1.08] mb-5 text-[clamp(1.45rem,6.4vw,1.95rem)] max-w-[370px]">
          {headline.replace(/\n/g, ' ')}
        </h2>

        <h2 className="hidden md:block font-serif text-panthera-white leading-tight mb-5 whitespace-pre-line text-[clamp(1.95rem,3.2vw,2.75rem)] max-w-4xl">
          {headline}
        </h2>
